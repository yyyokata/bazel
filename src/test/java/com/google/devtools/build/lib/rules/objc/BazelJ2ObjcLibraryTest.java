...
public class BazelJ2ObjcLibraryTest extends J2ObjcLibraryTest {
  ...
  private void testJ2ObjCInformationExportedFromJ2ObjcLibrary() throws Exception {
    ...
    assertThat(Artifact.toOutputRelativePaths(provider.get(ObjcProvider.LIBRARY)))
        .containsExactly(
    ...
    assertThat(Artifact.toOutputRelativePaths(provider.header()))
        .containsExactly(
  ...
  public void testJ2ObjcHeaderMappingAction() throws Exception {
    ...
    assertThat(Artifact.toOutputRelativePaths(mappingFileProvider.getHeaderMappingFiles()))
        .containsExactly(
    ...
    String execPath =
        getConfiguration(target).getBinDirectory(RepositoryName.MAIN).getExecPath() + "/";
    assertThat(Artifact.toOutputRelativePaths(headerMappingAction.getInputs()))
        .containsAtLeast(
  ...
  protected void checkObjcCompileActions(
    ...
    assertThat(Artifact.toOutputRelativePaths(compileAction.getPossibleInputsForTesting()))
