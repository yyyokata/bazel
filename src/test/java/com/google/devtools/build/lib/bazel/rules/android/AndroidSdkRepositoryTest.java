...
public class AndroidSdkRepositoryTest extends BuildViewTestCase {
  ...
  public void testSystemImageDirectoriesAreFound() throws Exception {
    ...
    assertThat(
        ...
        .containsExactly("src(external) system-images/android-25/default/armeabi-v7a/system.img");
    ...
    assertThat(
        ...
        .containsExactly("src(external) system-images/android-24/google_apis/x86/system.img");
  }
